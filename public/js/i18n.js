...
(function () {
  ...
  const TRANSLATIONS = {
    tr: {
      ...
      placeholder_eval_notes_user: 'Komisyon değerlendirme notu burada görünecektir.',
      help_eval_notes_user: 'Bu alan komisyon tarafından doldurulur, düzenleme yapılamaz.',
      ...
      notice_waiting_revision: 'Revizyon talep edildi. Başvurucu güncelleyip yeniden gönderdikten sonra işlem yapabilirsiniz.',
      notice_app_submitted: 'Başvurunuz komisyona değerlendirilmesi için gönderildi. Sonuç bekleniyor.',
      notice_app_in_review: 'Başvurunuz komisyon tarafından inceleniyor. Sonuç bekleniyor.',
      notice_app_revision_user: 'Komisyon başvurunuzu revize etmenizi talep etti. Lütfen notları inceleyip güncelleyerek tekrar gönderin.',
      notice_app_approved: 'Tebrikler! Başvurunuz komisyon tarafından onaylandı.',
      notice_app_rejected: 'Başvurunuz komisyon tarafından reddedildi. Detaylar için değerlendirme notunu inceleyebilirsiniz.',
      ...
      srv_err_app_delete_approved: 'Onaylanmış başvurular silinemez.',
      ...
      srv_err_eval_revision_pending: 'Başvurucu henüz revize etmedi. Yeniden gönderdikten sonra işlem yapabilirsiniz.',
      srv_err_eval_already_finalized: 'Bu başvuru zaten sonuçlandırılmış, değişiklik yapılamaz.',
    ...
    en: {
      ...
      placeholder_eval_notes_user: 'Committee evaluation note will appear here.',
      help_eval_notes_user: 'This field is filled by the committee and cannot be edited.',
      ...
      notice_waiting_revision: 'Revision requested. You can take action after the applicant updates and resubmits.',
      notice_app_submitted: 'Your application has been submitted to the committee for evaluation. Awaiting result.',
      notice_app_in_review: 'Your application is being reviewed by the committee. Awaiting result.',
      notice_app_revision_user: 'The committee has requested revisions. Please review the notes, update your application, and resubmit.',
      notice_app_approved: 'Congratulations! Your application has been approved by the committee.',
      notice_app_rejected: 'Your application has been rejected by the committee. Please review the evaluation notes for details.',
      ...
      srv_err_app_delete_approved: 'Approved applications cannot be deleted.',
      ...
      srv_err_eval_revision_pending: 'The applicant has not yet revised. You can take action after they resubmit.',
      srv_err_eval_already_finalized: 'This application has already been finalized and cannot be changed.',
