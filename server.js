...
const JWT_SECRET = 'atosis_super_secret_jwt_key_2026';
const ALLOWED_EMAIL_DOMAIN = '@aybu.edu.tr';
...
const defaultCategories = {
  kat1: {
    ...
    items: [
      { id: 'kat1_row1', label: 'Araştırma: Yurt Dışı / Research Abroad (Taban Puan * Ay)', baseScore: 10.0, maxScore: 120.0, requiresRatio: true, hasFormulaCap: false },
      { id: 'kat1_row2', label: 'Araştırma: Yurt İçi / Research Domestic (Taban Puan * Ay)', baseScore: 5.0, maxScore: 60.0, requiresRatio: true, hasFormulaCap: false },
      { id: 'kat1_row3', label: 'Makale: Q1 dergiler (SCI, SCI-E, SSCI, AHCI) / Q1 Journals', baseScore: 100.0, maxScore: 0.0, requiresRatio: true, hasFormulaCap: false },
      { id: 'kat1_row4', label: 'Makale: WoS Q2 dergiler (SCI, SCI-E, SSCI, AHCI) / Q2 Journals', baseScore: 80.0, maxScore: 0.0, requiresRatio: true, hasFormulaCap: false },
      { id: 'kat1_row5', label: 'Makale: WoS Q3 dergiler (SCI, SCI-E, SSCI, AHCI) / Q3 Journals', baseScore: 60.0, maxScore: 0.0, requiresRatio: true, hasFormulaCap: false },
      { id: 'kat1_row6', label: 'Makale: WoS Q4 dergiler (SCI, SCI-E, SSCI, AHCI) / Q4 Journals', baseScore: 40.0, maxScore: 0.0, requiresRatio: true, hasFormulaCap: false },
      { id: 'kat1_row7', label: 'Makale: Scopus, SPORT Discus, ESCI Dergileri / Scopus, SPORT Discus, ESCI-Index Journals', baseScore: 30.0, maxScore: 0.0, requiresRatio: true, hasFormulaCap: false },
      { id: 'kat1_row8', label: 'Makale: TR-Dizin Dergileri / TR-Index Journals', baseScore: 20.0, maxScore: 0.0, requiresRatio: true, hasFormulaCap: false },
      { id: 'kat1_row9', label: 'Makale: Diğer Uluslararası/Ulusal Hakemli Dergiler / Other Peer-Reviewed Journals', baseScore: 5.0, maxScore: 0.0, requiresRatio: true, hasFormulaCap: false },
      { id: 'kat1_row10', label: 'Uluslararası Bilimsel Kitap (BKCI) / Intl. Scientific Book (BKCI)', baseScore: 100.0, maxScore: 0.0, requiresRatio: true, hasFormulaCap: false },
      { id: 'kat1_row11', label: 'Uluslararası Bilimsel Kitap Bölümü (BKCI) / Intl. Book Chapter (BKCI)', baseScore: 50.0, maxScore: 0.0, requiresRatio: true, hasFormulaCap: false },
      { id: 'kat1_row12', label: 'Diğer Ulusl./Ulusal Bilimsel Kitap / Other Scientific Book', baseScore: 20.0, maxScore: 40.0, requiresRatio: true, hasFormulaCap: true },
      { id: 'kat1_row13', label: 'Diğer Ulusl./Ulusal Bilimsel Kitap Bölümü / Other Book Chapter', baseScore: 10.0, maxScore: 20.0, requiresRatio: true, hasFormulaCap: true },
      { id: 'kat1_row14', label: 'Özgün Eğitim Modeli, Yenilikçi İş Akışı, Kurumsal Yazılım / Original Education Model, Innovative Workflow, Institutional Software', baseScore: 75.0, maxScore: 0.0, requiresRatio: true, hasFormulaCap: false },
      { id: 'kat1_row15', label: 'Uluslararası Kişisel Sergi, Özgün Tasarım, Birincilik Ödülü / Intl. Solo Exhibition, Original Design, First Place Award', baseScore: 100.0, maxScore: 0.0, requiresRatio: true, hasFormulaCap: false },
      { id: 'kat1_row16', label: 'Ulusal Kişisel Sergi, Özgün Tasarım, Birincilik Ödülü / National Solo Exhibition, Original Design, First Place Award', baseScore: 75.0, maxScore: 0.0, requiresRatio: true, hasFormulaCap: false },
      { id: 'kat1_row17', label: 'Uluslararası Karma Sergi, Bienal vb. Katılım / Intl. Group Exhibition, Biennial, etc. Participation', baseScore: 50.0, maxScore: 0.0, requiresRatio: true, hasFormulaCap: false },
      { id: 'kat1_row18', label: 'Ulusal Karma Sergi, Alanlara Özgü Grup Etkinliği / National Group Exhibition or Discipline-Specific Group Event', baseScore: 30.0, maxScore: 0.0, requiresRatio: true, hasFormulaCap: false }
    ]
  },
  kat2: {
    id: 'kat2',
    ...
    items: [
      { id: 'kat2_row1', label: 'Projede Yürütücü / Project Principal Investigator', baseScore: 100.0, maxScore: 0.0, requiresRatio: false, hasFormulaCap: false },
      { id: 'kat2_row2', label: 'Projede Araştırmacı / Co-Investigator', baseScore: 70.0, maxScore: 0.0, requiresRatio: false, hasFormulaCap: false },
      { id: 'kat2_row3', label: 'Projede Danışman / Consultant', baseScore: 50.0, maxScore: 0.0, requiresRatio: false, hasFormulaCap: false },
      { id: 'kat2_row4', label: 'Projede Bursiyer / Project Scholar', baseScore: 20.0, maxScore: 0.0, requiresRatio: false, hasFormulaCap: false }
    ]
  },
  kat3: {
    id: 'kat3',
    ...
    items: [
      { id: 'kat3_row1', label: 'Uluslararası Tescillenmiş Patent / International Registered Patent', baseScore: 100.0, maxScore: 0.0, requiresRatio: true, hasFormulaCap: false },
      { id: 'kat3_row2', label: 'Ulusal Tescillenmiş Patent / National Registered Patent', baseScore: 75.0, maxScore: 0.0, requiresRatio: true, hasFormulaCap: false },
      { id: 'kat3_row3', label: 'Uluslararası Faydalı Model / International Utility Model', baseScore: 75.0, maxScore: 0.0, requiresRatio: true, hasFormulaCap: false },
      { id: 'kat3_row4', label: 'Ulusal Faydalı Model / National Utility Model', baseScore: 50.0, maxScore: 0.0, requiresRatio: true, hasFormulaCap: false }
    ]
  },
  kat4: {
    id: 'kat4',
    ...
    items: [
      { id: 'kat4_row1', label: 'Mezun Edilen Doktora Öğrencisi / Graduated PhD Student', baseScore: 50.0, maxScore: 0.0, requiresRatio: true, hasFormulaCap: false },
      { id: 'kat4_row2', label: 'Mezun Edilen Y. Lisans Öğrencisi / Graduated MA/MS Student', baseScore: 25.0, maxScore: 0.0, requiresRatio: true, hasFormulaCap: false },
      { id: 'kat4_row3', label: 'Öğrenci Yarışma Derecesi/Proje Danışmanlığı / Student Competition Award/Project Advising', baseScore: 20.0, maxScore: 40.0, requiresRatio: true, hasFormulaCap: false },
      { id: 'kat4_row4', label: 'Mesleki Gelişim (Eğitim Veren Rolü) / Professional Development (Instructor Role)', baseScore: 20.0, maxScore: 40.0, requiresRatio: true, hasFormulaCap: true },
      { id: 'kat4_row5', label: 'Mesleki Gelişim (Eğitim Alan Rolü) / Professional Development (Learner Role)', baseScore: 10.0, maxScore: 20.0, requiresRatio: true, hasFormulaCap: true },
      { id: 'kat4_row6', label: 'Ders Yükü (Taban Puan * Yıllık Toplam Ders Saati) / Course Load (Base Score * Total Annual Course Hours)', baseScore: 1.0, maxScore: 0.0, requiresRatio: true, hasFormulaCap: false },
      { id: 'kat4_row7', label: 'Öğrenci Anketleri (Taban Puan * Anket Ort Puan) / Student Surveys (Base Score * Survey Avr Score)', baseScore: 20.0, maxScore: 100.0, requiresRatio: true, hasFormulaCap: true },
      { id: 'kat4_row8', label: 'Kurumsal Koordinatörlük-Komite Görevi / Institutional Coord.-Committee Roles', baseScore: 30.0, maxScore: 60.0, requiresRatio: true, hasFormulaCap: true }
    ]
  }
};
...
function readDb() {
  ...
  try {
    ...
    return { users: [], applications: [], categories: defaultCategories };
  }
}
...
app.post('/api/auth/register', (req, res) => {
  ...
  const newUser = {
    ...
    department,
    title,
    role: 'user' // Default to normal academician
  };

  db.users.push(newUser);
  writeDb(db);

  res.status(201).json({ message: 'Kayıt işlemi başarıyla tamamlandı.' });
});
